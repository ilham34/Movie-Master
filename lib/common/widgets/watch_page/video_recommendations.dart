...
class VideoRecommendations extends StatelessWidget {
  final int movieId;
  const VideoRecommendations({required this.movieId, super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GenericDataCubit()..getData(sl<GetMovieRecommendationsUsecase>(), params: movieId),
